...
@implementation SettingController_iPad
...
- (void)viewDidLoad
{
    ...
    UILabel * topLabel = [Utils addCoverLabelToView:CGRectMake(0, 0, 768, 80) :0 :[UIColor clearColor] :@"Settings" :UITextAlignmentCenter :[UIColor blackColor]:[UIFont fontWithName:@"TrebuchetMS-Bold" size:30.0]];
    [self.view addSubview:topLabel];
    [topLabel release];
    
    UIButton * backButton   =   [Utils addCoverButtonToView:UIButtonTypeCustom :CGRectMake(30, 20, 40, 40) :0 :[UIImage imageNamed:@"backButton@2x.png"] :nil];
...
- (void) initImageViews{
    UIImageView * F_ImageView           =   [Utils addCoverImageViewToView:CGRectMake(50, 150, 660, 120) :[UIImage imageNamed:@"topbar.png"] :0 :1.0];
    UIImageView * S_ImageView           =   [Utils addCoverImageViewToView:CGRectMake(50, 350, 660, 120) :[UIImage imageNamed:@"topbar.png"] :0 :1.0];
    UIImageView * imageView_Font        =   [Utils addCoverImageViewToView:CGRectMake(50, 100, 140, 50) :[UIImage imageNamed:@"FontSizeTitle.png"] :0 :1.0];
    UIImageView * imageView_Sound       =   [Utils addCoverImageViewToView:CGRectMake(50, 300, 120, 50) :[UIImage imageNamed:@"SoundsLabel.png"] :0 :1.0];
    UIImageView * imageView_Submission  =   [Utils addCoverImageViewToView:CGRectMake(50, 500, 175, 50) :[UIImage imageNamed:@"SubmissionTitle.png"] :0 :1.0];
...
- (void) initLabels{
    UILabel * label_Sound       =   [Utils addCoverLabelToView:CGRectMake(70, 370, 280, 60) :0 :[UIColor clearColor] :@"Interface Sounds" :UITextAlignmentLeft :[UIColor blackColor] :[UIFont fontWithName:@"Arial-BoldMT" size:30]];
    UILabel * label_Feedback    =   [Utils addCoverLabelToView:CGRectMake(70, 580, 280, 60) :0 :[UIColor clearColor] :@"Submit Feedback" :UITextAlignmentLeft :[UIColor blackColor]:[UIFont fontWithName:@"Arial-BoldMT" size:30]];
    UILabel * label_NewJoke     =   [Utils addCoverLabelToView:CGRectMake(70, 740, 280, 60):0 :[UIColor clearColor] :@"Submit New Joke" :UITextAlignmentLeft :[UIColor blackColor] :[UIFont fontWithName:@"Arial-BoldMT" size:30]];
...
- (void) initButtons{
    UIButton * button_Feedback  =   [Utils addCoverButtonToView:UIButtonTypeCustom :CGRectMake(50, 550, 660, 120) :0 :[UIImage imageNamed:@"BlankSubmitButton.png"] :nil];
    UIButton * button_NewJoke   =   [Utils addCoverButtonToView:UIButtonTypeCustom :CGRectMake(50, 700, 660, 120):0 :[UIImage imageNamed:@"BlankSubmitButton.png"] :nil];
...
- (void) initSlider{
    ...
    UISlider *slider        =   [[UISlider alloc] initWithFrame:CGRectMake(100,190,550,10)];                                                          
...
- (void) initSwitch{
    UISwitch *switchView = [[UISwitch alloc] initWithFrame:CGRectMake(450, 385, 120, 60)];
    switchView.on = YES;
