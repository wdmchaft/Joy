...
+ (Renren *)newRenRen{
    ...
    newRenrenObject.appKey = [NetWorkConfig getSHKConsumerSignFromUrl:SHKRenRenConsumerKeyUrl];
    newRenrenObject.appId  = [NetWorkConfig getSHKConsumerSignFromUrl:SHKRenRenConsumerKeyUrl]; 
...
+ (Renren *)sharedRenren {
    if (!sharedRenren) {
        ...
        sharedRenren.appKey = [NetWorkConfig getSHKConsumerSignFromUrl:SHKRenRenConsumerKeyUrl];
        sharedRenren.appId  = [NetWorkConfig getSHKConsumerSignFromUrl:SHKRenRenConsumerKeyUrl];
    }
    return sharedRenren;
}
